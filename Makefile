...
curljob:
	curl -d "abortOnErrors=aOe&doImport=Start+Import&calcSize=cs&asNeeded=an" -u "$(shell docker exec -t hoardercache cat /etc/apt-cacher-ng/security.conf | sed 's|AdminAuth: ||')" 'http://127.0.0.1:3142/acng-report.html'
